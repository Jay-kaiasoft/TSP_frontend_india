                                ...
                                <div className='flex justify-center items-center'>
                                    <div>
                                            ...
                                            <Controller
                                                ...
                                                render={({ field }) => (
                                                    <Select
                                                        ...
                                                        label={"Shift Type"}
                                                        placeholder="Select type"
                                                        value={watch("shiftTypeId") || null}
                                                        onChange={(_, newValue) => {
                                                            if (newValue?.id) {
                                                                setValue("shiftTypeId", newValue.id);
                                                                setValue("shiftType", newValue.title);
                                                                if (newValue.title === "Hourly") {
                                                                    setValue("timeStart", null);
                                                                    setValue("timeEnd", null);
                                                                } else if (newValue.title === "Time Based") {
                                                                ...
                                                                setValue("shiftTypeId", null);
                                                                setValue("shiftType", null);
                                                            }
                                                        }}
                                                    />
                                                )}
                                            ...
                                            <Controller
                                                ...
                                                render={({ field }) => (
                                                    <Input
                                                        ...
                                                        disabled={watch("shiftTypeId") !== 1 ? true : false}
                                                    />
                                                )}
                                            />
                                        </div>
                                        ...
                                        <div className='flex justify-center items-center gap-4'>
                                            <div>
                                                <Button type={'button'} text={"Cancel"} onClick={hanndleClose} />
                                            </div>
